...
@NgModule({
  ...
  declarations: [AddcheckerComponent, AdddailyreportComponent,FileSelectDirective, ViewdailyreportComponent, AddpartComponent, ViewpartComponent, EditdailyreportComponent]
})
